$(document).ready(function(){  
  ...
  function eliminarTipoDocumento(url, inputNameId, tipoDocumento_id) {
  ...
  $('#data-table-contenedor').on('click', '.tipoDocumento-delete', function(e){
    e.preventDefault();
    dialog_abierto = true;
    boton_actual = $(this);
    abrir_dialog();
      ...
      "Si": function() {
        if(dialog_abierto) {
          ...
          if(typeof boton_actual === 'object') {
            ...
            var tipoDocumento_id = boton_actual.data('id');
            var inputNameId = boton_actual.data('name');
            javascript:eliminarTipoDocumento(url, inputNameId, tipoDocumento_id);
          }
        }
      },
      Cancel: function() {
