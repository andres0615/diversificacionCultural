$(document).ready(function(){  
  ...
  function eliminarTiposDocumento(url, ids) {
  ...
  $('#delete-select').click(function(e){
    ...
    $(".item-tipoDocumento-chk:checked").each(function(){
      ids.push($(this).val());
    });
      ...
      "Si": function() {
        if(dialog_abierto2) {
          ...
          if(typeof boton_actual2 === 'object') {
            ...
            javascript:eliminarTiposDocumento(url, ids);
          }
        }
      },
      Cancel: function() {
