$(document).ready(function(){
  ...
  $('#filtrar').click(function(e){
    ...
    var tipoDocumentoNombre = $('#tipoDocumento-nombre').val();
    var tipoDocumentoFechaInicial = $('#tipoDocumento-fechainicial').val();
    var tipoDocumentoFechaFinal = $('#tipoDocumento-fechafinal').val();

    var filterArray = {};
    
    filterArray['tipoDocumentoNombre'] = tipoDocumentoNombre;
    filterArray['tipoDocumentoFechaInicial'] = tipoDocumentoFechaInicial;
    filterArray['tipoDocumentoFechaFinal'] = tipoDocumentoFechaFinal;
