$(document).ready(function(){
  ...
  $('#filtrar').click(function(e){
    ...
    var categoriaNombre = $('#categoria-nombre').val();
    var categoriaFechaInicial = $('#categoria-fechainicial').val();
    var categoriaFechaFinal = $('#categoria-fechafinal').val();

    var filterArray = {};
    
    filterArray['categoriaNombre'] = categoriaNombre;
    filterArray['categoriaFechaInicial'] = categoriaFechaInicial;
    filterArray['categoriaFechaFinal'] = categoriaFechaFinal;
