$(document).ready(function(){  
  ...
  function eliminarCategoria(url, inputNameId, categoria_id) {
    
    var dataObject = {};
    dataObject[inputNameId] = categoria_id;
...
$('#data-table-contenedor').on('click', '.categoria-delete', function(e){
    e.preventDefault();
    dialog_abierto = true;
    boton_actual = $(this);
    abrir_dialog();
      ...
      "Si": function() {
        if(dialog_abierto) {
          ...
          if(typeof boton_actual === 'object') {
            ...
            javascript:eliminarCategoria(url, inputNameId, user_id);
          }
        }
      },
      Cancel: function() {
