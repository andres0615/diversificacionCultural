$(document).ready(function(){  
  ...
  function eliminarOrganizacion(url, inputNameId, organizacion_id) {
  ...
  $('#data-table-contenedor').on('click', '.organizacion-delete', function(e){
    e.preventDefault();
      ...
      "Si": function() {
        if(dialog_abierto) {
          ...
          if(typeof boton_actual === 'object') {
            ...
            var organizacion_id = boton_actual.data('id');
            var inputNameId = boton_actual.data('name');
            javascript:eliminarOrganizacion(url, inputNameId, organizacion_id);
          }
        }
      },
      Cancel: function() {
