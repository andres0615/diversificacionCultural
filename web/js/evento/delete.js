$(document).ready(function(){  
  ...
  function eliminarEvento(url, inputNameId, evento_id) {
    
    var dataObject = {};
    dataObject[inputNameId] = evento_id;
  ...
  $('#data-table-contenedor').on('click', '.evento-delete', function(e){
    e.preventDefault();
      ...
      "Si": function() {
        if(dialog_abierto) {
          ...
          if(typeof boton_actual === 'object') {
            ...
            var evento_id = boton_actual.data('id');
            var inputNameId = boton_actual.data('name');
            javascript:eliminarEvento(url, inputNameId, evento_id);
          }
        }
      },
      Cancel: function() {
