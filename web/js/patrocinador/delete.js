$(document).ready(function(){  
  ...
  function eliminarPatrocinador(url, inputNameId, patrocinador_id) {
...
$('#data-table-contenedor').on('click', '.patrocinador-delete', function(e){
    e.preventDefault();
    dialog_abierto = true;
    boton_actual = $(this);
    abrir_dialog();
      ...
      "Si": function() {
        if(dialog_abierto) {
          ...
          if(typeof boton_actual === 'object') {
            ...
            var patrocinador_id = boton_actual.data('id');
            var inputNameId = boton_actual.data('name');
            javascript:eliminarPatrocinador(url, inputNameId, patrocinador_id);
          }
        }
      },
      Cancel: function() {
