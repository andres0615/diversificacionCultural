$(document).ready(function(){
  ...
  function eliminarTarifa(url, inputNameId, tarifa_id) {
  ...
  function abrir_dialog(url, inputNameId, tarifa_id) {
    $( "#dialog" ).dialog("open");
  };

$('#data-table-contenedor').on('click', '.tarifa-delete', function(e){
    e.preventDefault();
    dialog_abierto = true;
    boton_actual = $(this);
    abrir_dialog();
      ...
      "Si": function() {
        if(dialog_abierto) {
          ...
          if(typeof boton_actual === 'object') {
            ...
            var tarifa_id = boton_actual.data('id');
            var inputNameId = boton_actual.data('name');
            javascript:eliminarTarifa(url, inputNameId, tarifa_id);
          }
        }
      },
      Cancel: function() {
