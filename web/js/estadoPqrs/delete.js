$(document).ready(function(){  
  ...
  function eliminarEstadoPqrs(url, inputNameId, estadoPqrs_id) {
...
$('#data-table-contenedor').on('click', '.estadoPqrs-delete', function(e){
    e.preventDefault();
    dialog_abierto = true;
    boton_actual = $(this);
    abrir_dialog();
      ...
      "Si": function() {
        if(dialog_abierto) {
          ...
          if(typeof boton_actual === 'object') {
            ...
            var estadoPqrs_id = boton_actual.data('id');
            var inputNameId = boton_actual.data('name');
            javascript:eliminarEstadoPqrs(url, inputNameId, estadoPqrs_id);
          }
        }
      },
      Cancel: function() {
