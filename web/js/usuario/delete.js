$(document).ready(function(){
  ...
  function eliminarUsuario(url, inputNameId, user_id) {
    
    var dataObject = {};
    dataObject[inputNameId] = user_id;
  ...
  $('#data-table-contenedor').on('click', '.user-delete', function(e){
    e.preventDefault();
      ...
      "Si": function() {
        if(dialog_abierto) {
          ...
          if(typeof boton_actual === 'object') {
            ...
            javascript:eliminarUsuario(url, inputNameId, user_id);
          }
        }
      },
      Cancel: function() {
