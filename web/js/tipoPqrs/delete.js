$(document).ready(function(){  
  ...
  function eliminarTipoPqrs(url, inputNameId, tipoPqrs_id) {
  ...
  function abrir_dialog(url, inputNameId, tipoPqrs_id) {
    $( "#dialog" ).dialog("open");
  };

  $('#data-table-contenedor').on('click', '.tipoPqrs-delete', function(e){
    e.preventDefault();
    dialog_abierto = true;
    boton_actual = $(this);
    abrir_dialog();
      ...
      "Si": function() {
        if(dialog_abierto) {
          ...
          if(typeof boton_actual === 'object') {
            ...
            var tipoPqrs_id = boton_actual.data('id');
            var inputNameId = boton_actual.data('name');
            javascript:eliminarTipoPqrs(url, inputNameId, tipoPqrs_id);
          }
        }
      },
      Cancel: function() {
