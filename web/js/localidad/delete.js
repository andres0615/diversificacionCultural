$(document).ready(function(){
  ...
  function eliminarLocalidad(url, inputNameId, localidad_id) {
  ...
  $('#data-table-contenedor').on('click', '.localidad-delete', function(e){
    e.preventDefault();
    dialog_abierto = true;
    boton_actual = $(this);
    abrir_dialog();
      ...
      "Si": function() {
        if(dialog_abierto) {
          ...
          if(typeof boton_actual === 'object') {
            ...
            var localidad_id = boton_actual.data('id');
            var inputNameId = boton_actual.data('name');
            javascript:eliminarLocalidad(url, inputNameId, localidad_id);
          }
        }
      },
      Cancel: function() {
