$(document).ready(function(){
  ...
  $('#filtrar').click(function(e){
    ...
    var localidadNombre = $('#localidad-nombre').val();
    var localidadFechaInicial = $('#localidad-fechainicial').val();
    var localidadFechaFinal = $('#localidad-fechafinal').val();

    var filterArray = {};
    
    filterArray['localidadNombre'] = localidadNombre;
    filterArray['localidadFechaInicial'] = localidadFechaInicial;
    filterArray['localidadFechaFinal'] = localidadFechaFinal;
