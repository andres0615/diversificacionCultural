...
//        $('body').css({'overflown':'hidden'});
      ...
      var mi_imagen_src = $('.box_skitter:first img').attr('src');
      mi_imagen.src = mi_imagen_src;
      mi_imagen.onload = setSkitterSize(this);     
      
//      mi_imagen.src="/tutores/images/mundo.gif";

//    this.settings.width_skitter = parseFloat(this.box_skitter.css('width'));
//    var ideal_height = (parseFloat(this.box_skitter.css('width')) * mi_imagen.height) / mi_imagen.width;
//    this.settings.height_skitter = parseFloat(ideal_height);
   

    function setSkitterSize(thisObj) {     
      
      console.log(mi_imagen_src);
      
      console.log(mi_imagen.width);
      
//      console.log($.setup);
      
      thisObj.settings.width_skitter = parseFloat(thisObj.box_skitter.css('width'));
      var ideal_height = (parseFloat(thisObj.box_skitter.css('width')) * mi_imagen.height) / mi_imagen.width;
      thisObj.settings.height_skitter = parseFloat(ideal_height);
      
    }      
      
//      this.settings.height_skitter = parseFloat(this.box_skitter.find('.image_main').height());
      
//      console.log(this.settings.width_skitter); 
      
      var width_img_1 = $('.image_main').width();
      
//      console.log(width_img_1);
      var box_skitter_width = parseFloat(this.box_skitter.css('width')) * mi_imagen.height;
      console.log(box_skitter_width);
