...
namespace mvc\config {
  ...
  class configClass {
    ...
    private static $show_sqlgetall;
    private static $upload_img_path;
    private static $upload_event_img_folder;
    private static $upload_profile_img_folder;
    private static $default_event_img;
    private static $default_profile_img;

    public static function getSohoFrameworkVersion() {
      return '1.0.12';
    }

    public static function getUploadEventImgFolder() {
      return self::$upload_event_img_folder;
    }

    public static function setUploadEventImgFolder($upload_event_img_folder) {
      self::$upload_event_img_folder = $upload_event_img_folder;
    }

    public static function getUploadProfileImgFolder() {
      return self::$upload_profile_img_folder;
    }

    public static function setUploadProfileImgFolder($upload_profile_img_folder) {
      self::$upload_profile_img_folder = $upload_profile_img_folder;
    }

    public static function getImgUploadPath() {
      return self::$upload_img_path;
    }

    public static function setImgUploadPath($upload_img_path) {
      self::$upload_img_path = $upload_img_path;
    }

    public static function getDefaultEventImg() {
      return self::$default_event_img;
    }

    public static function setDefaultEventImg($default_event_img) {
      self::$default_event_img = $default_event_img;
    }

    public static function getDefaultProfileImg() {
      return self::$default_profile_img;
    }

    public static function setDefaultProfileImg($default_profile_img) {
      self::$default_profile_img = $default_profile_img;
    }

    /**
     * Obtiene la variable que indica si se desea visulizar la sentencia sql que se
     * ejecuta en la funcion getAll de la clase tableBaseClass
     *
     * @return boolean
     */
    public static function getShowSqlGetAll() {
      return self::$show_sqlgetall;
    }

    /**
     * Configuro la variable que indica si se desea visulizar la sentencia sql que se
     * ejecuta en la funcion getAll de la clase tableBaseClass
     *
     * @param boolean $show_sqlgetall
     */
    public static function setShowSqlGetAll($show_sqlgetall) {
      self::$show_sqlgetall = $show_sqlgetall;
    }    
