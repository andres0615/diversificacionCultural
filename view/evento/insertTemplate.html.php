        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 home-item-3">
            ...
            <div class="content clearfix">
                ...
                <div class="login-fields">
                  ...
                  <form action="<?php echo routing::getInstance()->getUrlWeb('evento', 'create') ?>" method="POST" id="evento-form">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                      <div class="admin-item1" style="text-align: right;" >                
                        ...
                        <button class="button btn btn-success" id="submit-evento-form" >Registrar</button>
                      </div>
                    </div>
                  </div>
