        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 home-item-3">
            ...
            <div class="home-item-3-body" >
              <p>
                Posicionar nuestra  empresa en los primeros lugares de comercializacion y ventas 
                de nuestras casas a nivel nacional e internacional, brindando siempre toda la 
                informacion necesaria que requiera el cliente, para acceder a nuestros planes
                de vivienda siendo un ejemplo de orden, disciplina y servicio en nuestra labor.
              </p>
              <!--<br />-->
              <!--<br />-->
              <!--<br />-->
