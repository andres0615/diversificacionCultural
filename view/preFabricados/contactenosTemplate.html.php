      ...
      <div class="row" >
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 home-item-3">
            ...
            <div class="home-item-3-body" >
              <p>
                Llamenos para tener el gusto de atenderle, si es necesario le podemos hacer 
                una visita previa para hacer una inspeccion detallada del terreno donde desea 
                construir y asi poder aclarar todo lo relacionado al tema.
              </p>
              <!--<br />-->
              <!--<br />-->
              <!--<br />-->
