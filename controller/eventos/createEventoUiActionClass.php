 ...
 */
class createEventoUiActionClass extends controllerClass implements controllerActionInterface {
  ...
  public function execute() {
    try {
      ...
      if (request::getInstance()->isMethod('POST')) {
        ...
        //session::getInstance()->deleteAttribute(session::getInstance()->getUserName() . '_evento');
